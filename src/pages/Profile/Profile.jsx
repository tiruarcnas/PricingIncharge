...
class Profile extends Component {
  ...
  addUser(event) {
    ...
    console.log(userAdd);
    axios
      .post('http://localhost:9000/api/profile', userAdd)
      .then((res) => {
        console.log(res);
                ...
                <div className="profileUpdateLeft">
                  ...
                  <div className="profileUpdateItem">
                    ...
                    <input
                      ...
                      className="profileUpdateInput"
                      name="ReportingTo"
                      onChange={this.handleReportingToChange}
                  ...
                  <div className="profileUpdateItem">
                    ...
                    <input
                      ...
                      className="profileUpdateInput"
                      name="HQLocation"
                      onChange={this.handleHQLocationChange}
                      value={this.state.HQLocation}
                    />
                  </div>
                  <div className="profileUpdateItem">
                    ...
                    <input
                      ...
                      className="profileUpdateInput"
                      name="HQAddress"
                      onChange={this.handleHQAddressChange}
