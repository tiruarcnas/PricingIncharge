...
class NewUser extends Component {
  ...
  addCreate(event) {
    ...
    axios
      .post('http://localhost:9000/api/order', orderAdd)
      .then((res) => {
        console.log(res);
  ...
  savedorder = (event) => {
    ...
    axios
      .post('http://localhost:9000/api/savedorder', orderAdd2)
      .then((res) => {
        console.log(res);
        this.setState({ redirect: this.state.redirect === false });
      })
        ...
        <div className="userShow">
          ...
          <form onSubmit={this.addCreate} method="post" className="newUserForm">
            ...
            <div className="newUserItem">
              ...
              {/* <input type="text" name="ImportanceType" onChange={this.handleImportanceTypeChange} value={this.state.ImportanceType} placeholder="A/B/C" /> */}
              <select
                className="newUserSelect"
                name="ImportanceType"
                id="active"
                onChange={this.handleImportanceTypeChange}
                value={this.state.ImportanceType}
              >
                <option>Type</option>
            ...
            <div className="newUserItem">
              ...
              <input
                type="text"
                name="AddComments"
                onChange={this.handleAddCommentsChange}
                value={this.state.AddComments}
                placeholder="AddComments"
              />
            </div>
            <br />
            <div className="newUserItem">
            ...
            <div className="newUserItem2">
              <Link to="/users">
                <button className="newUserButton" onClick={this.savedorder}>
                  Save Order
                </button>
              </Link>
            </div>
